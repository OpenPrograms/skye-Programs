...
function fs_code()
  ...
  function fs.open(file,mode) if mode == nil then mode = "r" end return fs.invoke("open", file, mode) end
...
event_code,component_code,fs_code,text_code,terminal_code,serialization_code = nil,nil,nil,nil,nil,nil
